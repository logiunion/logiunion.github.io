...
for FILE in $(ls *.html); do
  ...
  export LANGCODE LOGI_NAME LOGI_OPEN_LETTER LOGI_GET_INVOLVED LOGI_ROUNDTABLE LOGI_SIGN_LETTER LOGI_JOIN_DISCORD LOGI_FILL_SURVEY LOGI_SIGNED LOGI_SIGN_LINK LOGI_SURVEY_LINK
